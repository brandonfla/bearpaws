...
**REQUIRED BACKGROUND:** You MUST understand bp:test-driven-development before using this skill. That skill defines the fundamental RED-GREEN-REFACTOR cycle. This skill adapts TDD to documentation.
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use bp:test-driven-development`
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST understand bp:systematic-debugging`
...
**REQUIRED BACKGROUND:** The bp:test-driven-development skill explains why this matters. Same principles apply to documentation.
