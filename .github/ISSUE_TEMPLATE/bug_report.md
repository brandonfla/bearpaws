...
## Is this a Bearpaws issue or a platform issue?
<!-- Bearpaws is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Bearpaws installed.

     If the problem persists without Bearpaws, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Bearpaws installed
